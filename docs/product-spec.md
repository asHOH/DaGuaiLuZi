...
- Owner-managed Rooms: members join by code/link, choose seats, and ready; the owner selects fixed/random seating and an ordinary Match or Challenge Hand, which auto-starts with six connected players. Browsing and discovery are post-MVP.

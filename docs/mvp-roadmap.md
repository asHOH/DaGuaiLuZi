...
| 3 | Remaining Room controls: lobby leave/ownership transfer, Seating Policy, interrupted-Room archival/replacement. | Required lifecycle actions work through the UI and preserve authority and configuration locks. |
